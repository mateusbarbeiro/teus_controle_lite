...
class VProductDetails extends StatelessWidget {
  ImageProvider<Object> handleProductImage(ProductDetailsStore store) {
    if (store.product?.thumbnail == null ||
          ...
          body: Observer(
              builder: (context) => NestedScrollView(
                    headerSliverBuilder: (_, __) => <Widget>[
                      SliverAppBar(
                        key: Key(_store.product?.id.toString() ??
                            UniqueKey().toString()),
                    ...
                    body: ListView(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle:
                              Text('${_store.product?.ncmFullDescription}'),
                        ),
                        ListTile(
                        ...
                        ListTile(
                          ...
                          trailing: Container(
                            width: width / 4,
                            child: IconButton(
                              onPressed: _store.product?.thumbnail == null || _store.product?.thumbnail == ''
                                  ? null
                                  : () async {
                                      await _store.launchApp(
                                          '${_store.product?.thumbnail}');
                                    },
                              // onPressed: () async {
